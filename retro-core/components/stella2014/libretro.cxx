...
void retro_run(void)
{
   ...
   // Keep the average audio rate exact instead of truncating away the fractional
   // sample count every video frame.
   static double tiaSampleRemainder = 0.0;
   double tiaSamplesFloat = (31400.0 / console->getFramerate()) + tiaSampleRemainder;
   uint32_t tiaSamplesPerFrame = (uint32_t)tiaSamplesFloat;
   tiaSampleRemainder = tiaSamplesFloat - tiaSamplesPerFrame;
