...
#define PROSYSTEM_EXT_RAM_BSS EXT_RAM_BSS_ATTR
#else
#define PROSYSTEM_EXT_RAM_BSS
#endif

uint8_t memory_ram[MEMORY_SIZE] = {0};
PROSYSTEM_EXT_RAM_BSS uint8_t memory_rom[MEMORY_SIZE] = {0};
PROSYSTEM_EXT_RAM_BSS uint8_t memory_souper_ram[MEMORY_SOUPER_EXRAM_SIZE] = {0};
